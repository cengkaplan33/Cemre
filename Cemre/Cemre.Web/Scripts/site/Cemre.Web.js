...
(function (Cemre) {
    ...
    })(Administration = Cemre.Administration || (Cemre.Administration = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Administration;
...
(function (Cemre) {
    ...
    })(Authorization = Cemre.Authorization || (Cemre.Authorization = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Administration;
...
(function (Cemre) {
    ...
    })(BasicSamples = Cemre.BasicSamples || (Cemre.BasicSamples = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Northwind;
    (function (Northwind) {
        var ProductDialog = (function (_super) {
            ...
            ProductDialog.prototype.getLanguages = function () {
                return Cemre.LanguageList.getValue();
            };
    ...
    })(Northwind = Cemre.Northwind || (Cemre.Northwind = {}));
})(Cemre || (Cemre = {}));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Cemre.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Cemre.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Cemre.Common.ReportHelper.execute({
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Cemre.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Cemre.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Cemre.Northwind.OrderDialog();
                        ...
                        var chai = Cemre.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Cemre.Northwind.EmployeeRow.getLookup().items
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Cemre.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    Cemre.Northwind.CategoryService.Retrieve({
        ...
        }(Cemre.Northwind.CategoryDialog));
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                this.customerPropertyGrid = new Serenity.PropertyGrid(this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(Cemre.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                this.customerForm = new Cemre.Northwind.CustomerForm(this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Cemre.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Cemre.Northwind.CustomerRow.lookupKey);
                ...
                this.form.CustomerID.change(function (e) {
                    ...
                    Cemre.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Cemre.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Cemre.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Cemre.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Cemre.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Cemre.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Cemre.Northwind.OrderService.baseUrl; };
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        ...
        }(Cemre.Northwind.SupplierDialog));
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Cemre.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Cemre.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Cemre.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Cemre.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Cemre.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
            }
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Cemre.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Cemre.Northwind.CustomerDialog));
...
(function (Cemre) {
    ...
    })(Common = Cemre.Common || (Cemre.Common = {}));
})(Cemre || (Cemre = {}));
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = Cemre.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Cemre.Northwind.ProductRow.lookupKey;
            };
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        ...
        }(Cemre.Northwind.OrderDetailsEditor));
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Cemre.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Cemre.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Cemre.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new Cemre.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = Cemre.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(Cemre.Northwind.OrderDetailDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Cemre.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Cemre) {
    ...
    Cemre.StaticTextBlock = StaticTextBlock;
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var BasicSamples;
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Cemre.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Cemre.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Cemre.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Cemre.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Cemre.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Cemre.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Cemre.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Cemre.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Cemre.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, Cemre.Northwind.OrderRow.Fields.ShipCountry);
...
(function (Cemre) {
    ...
    Cemre.SelectableEntityGrid = SelectableEntityGrid;
})(Cemre || (Cemre = {}));
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Cemre.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Cemre.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Cemre.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Cemre.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = Cemre.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Cemre.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Cemre.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Cemre.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Cemre.Northwind.ProductService.baseUrl; };
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Cemre.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Cemre.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Cemre.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: Cemre.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Cemre.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Cemre.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Cemre.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (Cemre) {
    ...
    Cemre.BasicProgressDialog = BasicProgressDialog;
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Cemre.BasicProgressDialog();
...
(function (Cemre) {
    ...
    })(DialogUtils = Cemre.DialogUtils || (Cemre.DialogUtils = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Common;
...
(function (Cemre) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Cemre.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Cemre.LanguageList || (Cemre.LanguageList = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Administration;
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Cemre.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Cemre.BasicSamples || (Cemre.BasicSamples = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Cemre.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return Cemre.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Cemre.BasicSamples || (Cemre.BasicSamples = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return Cemre.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return Cemre.StaticTextBlock; }], ['FromLocalText', function () { return Cemre.StaticTextBlock; }], ['DisplayFieldValue', function () { return Cemre.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Cemre.BasicSamples || (Cemre.BasicSamples = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
...
(function (Cemre) {
    ...
    })(Meeting = Cemre.Meeting || (Cemre.Meeting = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Meeting;
...
(function (Cemre) {
    ...
    })(Membership = Cemre.Membership || (Cemre.Membership = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Membership;
...
(function (Cemre) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Cemre.Northwind.Entities.Gender');
    })(Northwind = Cemre.Northwind || (Cemre.Northwind = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
...
(function (Cemre) {
    ...
    })(Organization = Cemre.Organization || (Cemre.Organization = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Organization;
...
(function (Cemre) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('Cemre');
    })(ScriptInitialization = Cemre.ScriptInitialization || (Cemre.ScriptInitialization = {}));
})(Cemre || (Cemre = {}));
var Cemre;
(function (Cemre) {
    var Common;
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: Cemre.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = Cemre.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Cemre.Authorization.userDefinition.DisplayName,
...
(function (Cemre) {
    ...
    (function (BasicSamples) {
        ...
        }(Cemre.Common.BulkServiceAction));
...
//# sourceMappingURL=Cemre.Web.js.map